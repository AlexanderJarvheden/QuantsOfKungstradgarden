...
![Your Mission Control dashboard](Prosperity4_DASHBOARD.png)
...
![The Algorithmic Challenge Overview](Prosperity4_ALGORITHMIC_CHALLENGE_OVERVIEW.png)
...
![The Upload & Changelog window](Prosperity4_ALGORITHM_UPLOAD_LOG.png)
...
![The Mission Control dashboard](Prosperity4_MANUAL_CHALLENGE_OVERVIEW.png)
...
![A.R.I.A. Uplinks are available from your Mission Control dashboard](Prosperity4_DASHBOARD.png)

A.R.I.A. Uplinks are available from your Mission Control dashboard

![A.R.I.A. Uplink videos provide all the essential information per round](Prosperity4_ARIA_UPLINK.png)
...
![The Outpost View provides an overview of your outpost](Prosperity4_OUTPOST_VIEW.png)
...
![The Leaderboard shows the ranking of all competing teams](Prosperity4_LEADERBOARD.png)
...
![The Crew Honors page shows all the badges your team collected (and the ones that you can still collect)](Prosperity4_CREW_HONORS.png)
...
![Your On-Board Advisor is available at the bottom right of your Outpost View](Prosperity4_OUTPOST_VIEW_WITH_OBA.png)
